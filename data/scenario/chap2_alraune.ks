...
; [cg f="alraune_h1_03"]              ← CG③（必要なら下に ④⑤... と追加可）
...
; [cg f="alraune_h2_03"]              ← CG③（必要なら下に ④⑤... と追加可）
[call storage="system/init.ks" target="*squeeze_event"]
[nm t="ナレーション"]
...
; [cg f="alraune_h3_03"]              ← CG③（必要なら下に ④⑤... と追加可）
[call storage="system/init.ks" target="*squeeze_event"]
[nm t="ナレーション"]
...
; [cg f="alraune_h4_03"]              ← CG③（必要なら下に ④⑤... と追加可）
[call storage="system/init.ks" target="*squeeze_event"]
[nm t="ナレーション"]
...
; [cg f="alraune_h5_03"]              ← CG③（必要なら下に ④⑤... と追加可）
[call storage="system/init.ks" target="*squeeze_event"]
[nm t="ナレーション"]
やがてアルラウネは離れていった。[p]
[if exp="f.from_recall==1"][eval exp="f.from_recall=0"][jump storage="recollection_room.ks" target="*recollection_start"][endif]
