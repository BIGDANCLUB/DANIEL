...
; [cg f="sr_succubus_h2_03"]              ← CG③（必要なら下に ④⑤... と追加可）
[call storage="system/init.ks" target="*squeeze_event"]
[nm t="ナレーション"]
...
; [cg f="sr_succubus_h3_03"]              ← CG③（必要なら下に ④⑤... と追加可）
[call storage="system/init.ks" target="*squeeze_event"]
[nm t="ナレーション"]
...
; [bgm_on f="h_scene"]              ← Hシーン用BGMに切り替え
; [cg f="sr_succubus_h4_01"]              ← CG①（最初）
[nm t="ナレーション"]
「降参するの？」上級サキュバスが静かに問いかけてきた。その声に——侮蔑はなかった。むしろ、柔らかい。[p]
; [cg f="sr_succubus_h4_02"]              ← CG②
[nm t="上級サキュバス" color="#dd88ff"]
...
; [cg f="sr_succubus_h4_03"]              ← CG③（必要なら下に ④⑤... と追加可）
[call storage="system/init.ks" target="*squeeze_event"]
[nm t="ナレーション"]
...
; [bgm_on f="h_scene"]              ← Hシーン用BGMに切り替え
; [cg f="sr_succubus_h5_01"]              ← CG①（最初）
[nm t="ナレーション"]
「今夜は時間があるの」と上級サキュバスは言った。その言葉の重みが、全身に沁み込んでくる。[p]
; [cg f="sr_succubus_h5_02"]              ← CG②
[nm t="上級サキュバス" color="#dd88ff"]
...
; [cg f="sr_succubus_h5_03"]              ← CG③（必要なら下に ④⑤... と追加可）
[nm t="上級サキュバス" color="#dd88ff"]
「……レン」[l]
[nm t="ナレーション"]
